...
<h3 align="justify">Fresh-graduate software engineering with internship experience as a web developer. Web developer using with HTML, CSS, and JavaScript. To secure a web developer position that utilizes my expertise in Node.js, software development, and database technology to develop and implement program for web applications.</h3>
